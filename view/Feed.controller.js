...
sap.ui.controller("com.sap.scn.gw.apcecho.view.Feed", {
  oTimeConv: sap.ui.core.format.DateFormat.getDateTimeInstance({
    pattern: "yyyyMMddHHmmss"
  }),
  oFormat: sap.ui.core.format.DateFormat.getDateTimeInstance({
    style: "medium"
  }),
  ...
  getWsConnection: function(oModel) {
    ...
    this.oWs.attachClose(function(e) {
      ...
      setTimeout(function(){this.getWsConnection(oModel)}.bind(this),  1000);
    }.bind(this));
