sap.ui.controller("com.sap.scn.gw.apcecho.view.Feed", {
	...
	getWsConnection: function(oModel) {
		...
		this.oWs.attachMessage(function(oEvent) {
			...
			var oTimeConv = sap.ui.core.format.DateFormat.getDateTimeInstance({
				pattern: "yyyyMMddHHmmss"
			});
			var oFormat = sap.ui.core.format.DateFormat.getDateTimeInstance({
				style: "medium"
			});
			var ts = oTimeConv.parse(oEntry.LS_MESSAGE.DATE);
			oEntry.Date = oFormat.format(ts);
			// update model
